  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div style="font-size:25px; color:red;" >ادارة المكتبة</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة الكتب</span></li>
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة القسم</span></li>
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة المؤلفين</span></li>
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة النشر</span></li>
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة المدن</span></li>
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة التقديم</span></li>
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة الطلبات</span></li>

        <li class="menu-item">
          <a href="new_order" class="menu-link">
            <div>Orders </div>
          </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">ادارة الدفع</span></li>

        <li class="menu-item">
          <a href="new_payment" class="menu-link">
            <div>Payment_Methodes</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="new_payment" class="menu-link">
            <div>Sow Pay_Methodes</div>
          </a>

        </li>

        <li class="menu-header small text-uppercase"><span class="menu-header-text"style="color:red;">Maneg &amp; Category</span></li>
        <li class="menu-item">
...
<div class="card mb-4">
  <h5 class="card-header">اضافة مستخدم</h5>
