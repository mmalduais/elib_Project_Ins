...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item">
  <a href="add_userr" class="menu-link">
    <div>انشاء مستخدم</div>
  </a>
</li>
<li class="menu-item">
  <a href="/userr" class="menu-link">
...
<a href="/auther" class="menu-link">
 ...
 <li class="menu-header small text-uppercase"><span class="menu-header-text">ادارة النشر</span></li>

<li class="menu-item">
<a href="add_publisher" class="menu-link">
  <div>انشاء  دار النشر</div>
</a>
</li>
<li class="menu-item">
